...
fn ber() {
    ...
    assert_eq!(EXPECTED, rasn::der::encode(&PersonnelRecord::default()).unwrap());
}
...
fn aper() {
    ...
    assert_eq!(EXPECTED, rasn::aper::encode(&PersonnelRecord::default()).unwrap());
}
...
fn uper() {
    ...
    assert_eq!(EXPECTED, rasn::uper::encode(&PersonnelRecord::default()).unwrap());
}
